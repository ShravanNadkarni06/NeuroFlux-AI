...
6. CRITICAL SCALE RULE: Whenever you output or reference any Air Quality Index (AQI) number in your responses, you MUST ALWAYS accompany it with both its qualitative rating label ("Good", "Fair", "Moderate", "Poor", or "Very Poor") and the explicit standard 1-5 scale descriptor alongside it. Never show a bare number without these details.`;
